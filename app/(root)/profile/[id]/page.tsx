        ...
        <div className="flex flex-col items-start gap-4 lg:flex-row">
          ...
          <div className="mt-3">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-start gap-5">
              {user.portfolioWebsite && <ProfileLink
              ...
              title={`Joined ${formatMonthYear(user.joinedAt)}`}
               />
            </div>
      ...
      <div className="mt-10 flex gap-10">
        <Tabs defaultValue="top-posts" className="flex-1">
          ...
          <TabsContent value="top-posts">
            <QuestionTab searchParams={searchParams} userId={user._id} clerkId={clerkId} />
          </TabsContent>
          <TabsContent value="answers">
            <AnswerTab searchParams={searchParams} userId={user._id} clerkId={clerkId} />
          </TabsContent>
        </Tabs>
      </div>
    </>
